        ...
        <div class="py-4">
          <div class="p-4">
            <div class="flex gap-2">
              <PrimaryButton @click="file" class="bg-green-600"
                >File a Complaint</PrimaryButton
              >
            </div>
            <div class="flex gap-2">
              <h1>My Complaints</h1>
            ...
            <div v-if="!loading">
              <div
                v-if="complaints?.reports.data.length"
                class="flex flex-col gap-2"
              >
                <div
                  @click="view(complaint.reference_number)"
                  v-for="complaint in complaints.reports.data"
                  :key="complaint.id"
                ...
                >
                  ...
                  <div>
                    <span
                      >Type: {{ formatReportType(complaint.report_type) }}</span
                    >
                  </div>
                  <div>
