...
<template>
  <form
    ...
    class="p-5 bg-green-200 rounded-badge shadow-md"
  >
    <div>
    ...
    <div>
      ...
      <input
        v-model="updatePersonal.firstname"
        type="text"
        id="line1"
    ...
    <div>
      ...
      <input
        v-model="updatePersonal.middlename"
        type="text"
        id="line1"
        class="input input-bordered w-full"
      />
    ...
    <div>
      ...
      <input
        v-model="updatePersonal.lastname"
        type="text"
        id="line1"
        class="input input-bordered w-full"
      />
    ...
    <div>
      ...
      <select
        v-model="updatePersonal.barangay"
